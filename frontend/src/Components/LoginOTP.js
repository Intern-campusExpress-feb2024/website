/* To test Sign-in with Phone  functionaliy, please make following changes
    1. Please download Login.js file and paste it in your ReactJS LoginOTP home directory.
...
const LoginOTP = () => {
  ...
  const httpRequest = async () => {
    try {
      ...
      data.LoginOTPend("access_token", accessToken);
      data.LoginOTPend("client_id", CLIENT_ID);
      ...
      //curl --location --request POST "https://api.phone.email/v1/sendmail" --ssl-no-revoke --header "Content-Type: LoginOTPlication/json" --data-raw "{'apiKey':'API_KEY','fromCountryCode':'XXX','fromPhoneNo':'XXXXXXXXXX', 'toCountrycode':'XX','toPhoneNo':'XXXXXXXXXX','subject': 'Welcome to YOUR_BUSINESS_NAME','tinyFlag':true,'messageBody':'V2VsY29tZSB0byB5b3VyIEJVU0lORVNTX05BTUU='}"
        ...
        >
          <div
            style={{
              ...
              margin: "0 auto",
              fontFamily:
                "sans-serif, serif, system-ui, -LoginOTPle-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif",
              lineHeight: "28px",
              display: "flex",
